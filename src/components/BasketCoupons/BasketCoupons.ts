...
import { Buttons, Symbols } from '../../common.types/enums';
...
class BasketCoupons {
  render(): string {
    return `
      <div class="coupons">
        <span class="coupons__title">${Titles.APPLY}</span>
        <div class="coupons__input">
          <input class="coupons__input__value" type="text" placeholder="${Titles.COUPON_PLACEHOLDER}">
          <button class="coupons__input__clear-button">${Buttons.CLEAR_INPUT}</button>
        </div>
        <div class="coupons__res">
          <span class="coupons__res__value">${this.getCouponByName('TREE')?.name}</span>
          <button class="coupons__res__add">${Buttons.COUPON_ADD}</button>
        </div>
        <div class="coupons__active">
          <p class="coupons__active__title">${Titles.ACTIVE}</p>
          <div class="coupons__active__element">
            <span class="coupons__active__element__name">${this.getCouponByName('DECORATIONS')?.name}</span>
            <span class="coupons__active__element__value">${this.getCouponByName('DECORATIONS')?.discount}${Symbols.DISCOUNT}</span>
        ...
        <div class="coupons__possible">
          <span class="coupons__possible__title">${Titles.TEST_HINT}</span>
